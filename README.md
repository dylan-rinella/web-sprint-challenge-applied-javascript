...
2. What is an event?
An event is any instance of something happening on the DOM

3. What is an event listener?
an event listeners are elements that wait to an event to happen before firing

4. Why would we convert a NodeList into an Array?
dont know

5. What is a component?
a component is a piece to a multi-layer DOM
